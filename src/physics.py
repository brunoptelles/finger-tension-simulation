...
def calc_tensao_dedo(F, rp, rs, l, teta, razao_elastica = 1):
    ...
    return np.array([0, Fp, Fs])


def calc_forca_dedo(T, rp, rs, l, teta, dir, razao_elastica = 1):
    #l = [l1, l2, l3]  rs = [rs1, rs2, 0]   rp = [rp1, rp2, rp3]   teta = [teta1, teta2, teta3]
